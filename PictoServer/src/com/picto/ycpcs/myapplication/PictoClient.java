...
public class PictoClient extends Thread {
	...
	public PictoClient(Socket clientSocket,PictoDB database,ApplicationState appstate) {
	...
	*/
	public boolean Send(PictoMessage msg)
	{
		boolean rv = false;
		try 
        {
	...
	public PictoMessage ReceiveMsg()
	{
	        ...
	        {	
	        	...
	        	if(buf_in_stream.available() > 0)
	        	{
		        	...
		        	else if(commandType == CommandHeader.CMD_READ_MSG)
		        	{
			        	...
			        	// convert the message buffer to message object
			        	msg =  PictoMessage.bytesToPictoMessage(receivedMessage);
			        	System.out.println("READ Message: " + "From: " + msg.fromAddress() + " To: " + msg.toAddress() + " Message text:  "+ msg.textMessage() + " image filename: " + msg.contentFileName());
