...
public class PictoMessage implements Serializable{
	 ...
	 * 
	 */
	//pPictoMessage serialVersionUID
 ...
 // get the message from: address 
    ...
    public synchronized String toString()
    {
        ...
        {
            return (textMessage() + "_" + contentSettings());
        }
    ...
    // convert the message to a byte array
	   static synchronized byte[] pictoMessageToBytesSerial(PictoMessage item)
	    {
	...
	// convert the byte array to a message
	   static synchronized PictoMessage bytesToPictoMessageSerial(byte[] itemBytes)
	    {
    ...
    public static synchronized byte[] pictoMessageToBytes(PictoMessage item) throws Exception
    {
        ...
        int exportBufferLen = 4 + // length of entire buffer
                ...
                4 + contentSettingsLen + // 4 byte length of content settings followed by to content filename
                4 + contentLen;
